...
# Description --------------------------------------------------------------------------------------------------------------
    ...
    # 1. ORF prediction on reassembled bins with Prodigal
    ...
    # Input: ${reassemDir}/${ID}/reassembled_bins/*.fa (reassembled bins from 3.3_reassemble_bins.sh)
...
# Print script information to log ------------------------------------------------------------------------------------------
    H1 "Description: 5.6_AA_amr_bins.sh"
        echo -e "This script does the following:"
        echo -e "1. ORF prediction with Prodigal (on reassembled bins)"
